...
insert  into `tbl_attendance`(`attendance_id`,`student_id`,`attendance_status`,`attendance_date`,`lecturer_id`) values
...
CREATE TABLE `tbl_lecturer` (
  ...
  `lecturer_emailid` varchar(100) NOT NULL,
  `lecturer_password` varchar(100) NOT NULL,
  `lecturer_qualification` varchar(100) NOT NULL,
  `lecturer_doj` date NOT NULL,
  `lecturer_image` varchar(100) NOT NULL,
  `lecturer_grade_id` int(11) NOT NULL,
  PRIMARY KEY (`lecturer_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

/*Data for the table `tbl_lecturer` */

insert  into `tbl_lecturer`(`lecturer_id`,`lecturer_name`,`lecturer_address`,`lecturer_emailid`,`lecturer_password`,`lecturer_qualification`,`lecturer_doj`,`lecturer_image`,`lecturer_grade_id`) values
